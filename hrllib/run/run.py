...
parser.add_argument("--simulation_size", dest="simulation_size", type=int, default=1000, help="The number of simulated sessions in each simulated epoch.")
...
parser.add_argument('--test',dest="test",type=str,default="./data_preprossing/output/data/total_200.csv")
max_turn =22
parser.add_argument('--piors',dest="piors",type=str,default="./data/basic/all_piors.json")
parser.add_argument('--context',dest="context",type=boolean_string, default=True)
#save model
parser.add_argument('--checkpoint_path',dest="checkpoint_path",type=str,default = "./hrloutput/")
parser.add_argument('--saved_model',dest="saved_model",type=str,default = "./hrloutput/")
# reward design
...
parser.add_argument("--weight_for_reward_shaping", dest='weight_for_reward_shaping', type=float, default=1.0, help="weight for reward shaping. 0 means no reward shaping.")
